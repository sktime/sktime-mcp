...
try:
    ...
    print(f"\n[SKIP] Could not run SQL example due to missing optional dependency: {e}")
    print("To run this example, please install the SQL extra: pip install sktime-mcp[sql]")
    print("Or install sqlalchemy directly: pip install sqlalchemy")
